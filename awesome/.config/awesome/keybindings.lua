...
function globalkeys(gears,awful)
  gears.table.join(
    ...
    awful.key({ modkey,"Shift"}, "o",function() require("awful").screen.focused().selected_tag.gap = require("awful").screen.focused().selected_tag.gap-2 end,
              {description="sets kayboard to us", group="awesome"}),
